...
- 记忆写入超时独立配置【已实现/已存在】：记忆批处理写入构建 LLM 客户端时单独读取 `MEMORY_WRITE_LLM_TIMEOUT`，默认 600 秒，不再复用通用调用超时（`tasks.py:81-106`）。
...
## 7. 证据来源
`server/apps/opspilot/{urls.py:41,139-143,models/*,services/*,services/skill_package/{importer.py:28,runtime.py:56},metis/llm/*,tasks.py:81-106,1257-1299,config.py,nats_api.py,utils/enterprise_wechat_aibot_chat_flow_utils.py:61-211,utils/workflow_sensitive_config.py:8-118,utils/chat_flow_utils/nodes/action/action.py:23-59,255-299,management/commands/{init_bot.py:9,init_chatflow.py:9,init_llm.py:9,parse_tools_yml.py:18}}`；模型表见 `models/{model_provider_mgmt.py:256,296,bot_mgmt.py:270-275,knowledge_mgmt.py,memory_mgmt.py,user_pin.py}`；初始化服务见 `services/{bot_init_service.py:14,chatflow_init_service.py:129,model_provider_init_service.py:14}`；内置工具见 `metis/llm/tools/tools_loader.py:31-52`、`services/builtin_tools.py`；protocol_type 持久化见 `migrations/0049_modelvendor_protocol_type.py`。
