...
from classify_object_detection_server.training.trainer import UniversalTrainer
from classify_object_detection_server.training.config.loader import TrainingConfig
...
class CLI:
    ...
    def train(self, dataset_yaml: str, config: str, run_name: str = None):
        ...
        try:
            ...
            result = trainer.train(str(dataset_yaml_path))
