...
class TrainingConfig:
    ...
    def set(self, *keys, value) -> None:
        ...
        Example:
            config.set('mlflow', 'run_name', value='my_run')
        """
        if not keys:
    ...
    def mlflow_experiment_name(self) -> str:
        ...
        if not isinstance(exp_name, str):
            logger.warning(f"experiment_name类型错误({type(exp_name).__name__})，已转换为字符串")
