...
class MLFlowUtils:
    ...
    def flatten_dict(d: dict, parent_key: str = "", sep: str = ".") -> dict:
        ...
        Examples:
            ...
            {
                "hyperparams.search_space.max_iter": [50, 100, 150],
    ...
    def plot_coverage_overview(
        ...
        ax2.text(
            0.1,
            health_y,
            f"健康度评估: {health_icon} {health_status}",
            fontsize=14,
            weight="bold",
            color=health_color,
            bbox=dict(
    ...
    def plot_coverage_comparison(
        ...
        # 计算统计数据
        train_covered, train_uncovered, train_rate, train_clusters = calc_stats(
            train_cluster_ids
        )
        test_covered, test_uncovered, test_rate, test_clusters = calc_stats(
            test_cluster_ids
        )
        ...
        def plot_panel(
            ...
            for i, (name, value, color) in enumerate(metrics_data):
                ...
                ax_metrics.text(
                    0.15, y_pos - 0.08, value, fontsize=22, weight="bold", color=color
                )
