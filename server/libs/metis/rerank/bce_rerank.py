...
class BCEReRank:
    def __init__(
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, cache_dir='./models', **kwargs)
        self.model = AutoModelForSequenceClassification.from_pretrained(model_name_or_path, cache_dir='./models',
                                                                        **kwargs)
    ...
    def rerank(
        ...
        sentence_pairs, sentence_pairs_pids = self.reranker_tokenize_preproc(
            query, passages,
