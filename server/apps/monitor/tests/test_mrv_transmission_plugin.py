"""Contract tests for the MRV transmission SNMP plugin.

MRV OptiDriver optical transmission devices (PEN 33) are modelled as the
Transmission object. The state queue names MRV-IN-REACH-SYSTEM-MIB availability,
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_mrv"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "mrv"
COLLECT_TYPE = "snmp_mrv"
CONFIG_TYPE = "mrv"
