"""Contract tests for the Alcoma transmission SNMP plugin.

Alcoma microwave transmission devices (PEN 12140) are modelled as the
Transmission object. The state queue names ALCOMA-MIB availability,
...
metadata. Private microwave/radio transmission health metrics are N/A until
raw ALCOMA-MIB objects can be pinned to stable device-health semantics.
"""
import json
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_alcoma"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "alcoma"
COLLECT_TYPE = "snmp_alcoma"
CONFIG_TYPE = "alcoma"
INSTANCE_TYPE = "transmission"
PLUGIN_NAME = "Transmission Alcoma SNMP"
OBJECT_NAME = "Transmission"

PRIVATE_PEN_ROOT = "1.3.6.1.4.1.12140"
HEALTH_METRICS = (
    "device_cpu_usage",
    "device_memory_used",
    "device_memory_free",
...
def test_no_private_health_metrics_without_exact_oid_source(metrics):
    ...
    for absent in HEALTH_METRICS:
        assert absent not in names, f"{absent} needs verified Alcoma OID source -> N/A"
