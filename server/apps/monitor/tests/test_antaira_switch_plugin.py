"""Contract tests for the Antaira switch SNMP plugin.

Antaira industrial managed Ethernet switches are confirmed to support SNMP
v1/v2c/v3 and use enterprise PEN 38477, but the current state has not confirmed
public row-filter-free scalar CPU, memory, temperature, fan or power-supply
OIDs. This is therefore a conservative baseline child: metrics.json declares no
vendor metric deltas, while the shared Switch SNMP floor supplies uptime,
...
BRAND_DIR = PLUGINS / "snmp" / "switch_antaira"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "antaira"
COLLECT_TYPE = "snmp_antaira"
CONFIG_TYPE = "antaira"
INSTANCE_TYPE = "switch"
PLUGIN_NAME = "Switch Antaira SNMP"
OBJECT_NAME = "Switch"
PEN_ROOT = "1.3.6.1.4.1.38477"
...
def test_new_files_do_not_leak_external_source_names():
    checked_paths = [
        ...
        Path(__file__),
        WEB_ROOT / "public" / "assets" / "icons" / "mm-antaira_antaira.svg",
    ]
