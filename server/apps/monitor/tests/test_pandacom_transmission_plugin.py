"""Contract tests for the Pan Dacom transmission SNMP plugin.

Pan Dacom CWDM/optical transmission devices (PEN unknown from state row) are modelled as the
Transmission object. The state queue names public Pan Dacom MIB availability, but this
...
traffic + device_total_* roll-ups, with private optical/CWDM health metrics N/A.
"""
import json
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_pandacom"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "pandacom"
COLLECT_TYPE = "snmp_pandacom"
CONFIG_TYPE = "pandacom"
INSTANCE_TYPE = "transmission"
PLUGIN_NAME = "Transmission Pan Dacom SNMP"
...
def test_no_private_health_metrics_without_exact_oid_source(metrics):
    ...
    for absent in (
        ...
        assert absent not in names, f"{absent} needs verified Pan Dacom OID source -> N/A"
