"""Contract tests for the Smartoptics transmission SNMP plugin.

Smartoptics DCP and M-Series WDM/DWDM devices are currently handled as a
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_smartoptics"
...
PLUGIN_NAME = "Transmission Smartoptics SNMP"
...
def test_brand_match_and_icon_present_in_common():
    ...
    assert "mm-smartoptics_smartoptics" in text
    assert (WEB_ROOT / "public" / "assets" / "icons" / "mm-smartoptics_smartoptics.svg").exists()
...
def test_new_files_do_not_leak_external_source_names():
    checked_paths = [
        ...
        Path(__file__),
        WEB_ROOT / "public" / "assets" / "icons" / "mm-smartoptics_smartoptics.svg",
    ]
