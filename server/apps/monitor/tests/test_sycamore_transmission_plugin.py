"""Contract tests for the Sycamore transmission SNMP plugin.

Sycamore optical switching equipment is represented by enterprise PEN 2411, but
...
zero-delta child, and does not promote optical switching counters into shared
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_sycamore"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "sycamore"
COLLECT_TYPE = "snmp_sycamore"
CONFIG_TYPE = "sycamore"
INSTANCE_TYPE = "transmission"
PLUGIN_NAME = "Transmission Sycamore SNMP"
OBJECT_NAME = "Transmission"
PEN_ROOT = "1.3.6.1.4.1.2411"
...
def test_brand_label_present_in_common():
    ...
    assert "Sycamore" in text
    assert "mm-sycamore_sycamore" in text


@pytest.mark.unit
def test_brand_svg_exists():
    assert (WEB_ROOT / "public" / "assets" / "icons" / "mm-sycamore_sycamore.svg").exists()
...
def test_brand_files_have_no_external_source_residue():
    ...
    paths = list(BRAND_DIR.glob("*")) + [
        WEB_ROOT / "public" / "assets" / "icons" / "mm-sycamore_sycamore.svg"
    ]
    offenders = {
