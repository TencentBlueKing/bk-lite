"""Contract tests for the BridgeWave transmission SNMP plugin.

BridgeWave millimeter-wave wireless transmission devices are currently handled
...
BRAND_DIR = PLUGINS / "snmp" / "transmission_bridgewave"
LANGUAGE_DIR = SERVER_ROOT / "apps" / "monitor" / "language"
WEB_ROOT = SERVER_ROOT.parents[0] / "web"

BRAND = "bridgewave"
COLLECT_TYPE = "snmp_bridgewave"
CONFIG_TYPE = "bridgewave"
INSTANCE_TYPE = "transmission"
PLUGIN_NAME = "Transmission BridgeWave SNMP"
...
def test_brand_match_and_icon_present_in_common():
    ...
    assert "mm-bridgewave_bridgewave" in text
    assert (WEB_ROOT / "public" / "assets" / "icons" / "mm-bridgewave_bridgewave.svg").exists()
...
def test_new_files_do_not_leak_external_source_names():
    checked_paths = [
        ...
        Path(__file__),
        WEB_ROOT / "public" / "assets" / "icons" / "mm-bridgewave_bridgewave.svg",
    ]
