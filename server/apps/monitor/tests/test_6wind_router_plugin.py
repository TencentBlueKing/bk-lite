"""Contract tests for the 6WIND VSR router SNMP plugin.

6WIND VSR routers currently have a verified baseline profile: standard MIB-II
...
PLUGIN_DIR = PLUGINS / "snmp" / "router_6wind"
...
PLUGIN_NAME = "Router 6WIND VSR SNMP"
OBJECT_NAME = "Router"
PRIVATE_PEN_ROOT = "1.3.6.1.4.1.7336"
...
def test_no_private_health_metrics_modelled(metrics):
    ...
    assert present == [], f"6WIND baseline plugin must not model private health metrics: {present}"
