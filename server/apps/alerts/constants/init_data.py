...
from apps.alerts.constants.constants import AlertAccessType, AlertsSourceTypes, LevelType
...
SYSTEM_SETTINGS = [
    {
        ...
        "value": {"notify_every": 60, "notify_people": [], "notify_channel": []},
...
def build_k8s_source_config():
    ...
    config["event_fields_desc_mapping"]["push_source_id"] = "事件来源 | 类型: string | 必填: 否(默认k8s) | 说明: 标记具体由哪个K8s推送链路或上游模块推送, 默认为k8s, 支持用户在YAML中修改"
    return config
...
def build_snmp_trap_source_config():
    ...
    config["event_fields_desc_mapping"]["push_source_id"] = "事件来源 | 类型: string | 必填: 否(默认snmp_trap_bridge) | 说明: 标记由哪个 SNMP Trap bridge 推送"
    return config
...
BUILTIN_ALERT_SOURCES = [
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置的 restful 集成源, 监控系统可以通过 RESTful API 的方式推送 EVENT",
    ...
    },
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置 NATS 集成源, 通过 NATS 网关接收数据",
    ...
    },
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置 Prometheus 集成源, 支持 Alertmanager 默认 webhook 并自动转换为标准事件",
    ...
    },
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置 Zabbix 集成源, 支持 Webhook Media Type 并以 ProblemId 进行告警恢复闭环",
    ...
    },
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置 K8s 集成源, Kubernetes Event Exporter 可通过此通道推送事件",
    ...
    },
    {
        ...
        "is_active": True,
        "is_effective": True,
        "description": "内置 SNMP Trap 集成源, 独立 bridge 可通过 source webhook 推送规范化事件",
