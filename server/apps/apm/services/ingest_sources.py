...
class DjangoIngestSourceService:
    ...
    def render_snippet(self, request: IngestSnippetRequest) -> IngestSnippet:
        ...
        commands = {
            ...
            "java": "java -javaagent:/opt/opentelemetry-javaagent.jar -jar app.jar",
            "go": "# Initialize the OpenTelemetry Go SDK before starting your application.",
        }
        ...
        export_lines.append(commands.get(request.language, "# Start the instrumented application."))
        code = "\n".join(export_lines)
