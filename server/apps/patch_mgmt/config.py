...
# Linux yum/dnf 仓库元数据同步上限（压缩体积 / 解压体积 / 公告数 / 单公告包数）
LINUX_REPO_SYNC_MAX_COMPRESSED_BYTES = _int_env(
    "PATCH_LINUX_REPO_SYNC_MAX_COMPRESSED_BYTES", 32 * 1024 * 1024
)
LINUX_REPO_SYNC_MAX_UNCOMPRESSED_BYTES = _int_env(
    "PATCH_LINUX_REPO_SYNC_MAX_UNCOMPRESSED_BYTES", 128 * 1024 * 1024
)
LINUX_REPO_SYNC_MAX_ADVISORIES = _int_env("PATCH_LINUX_REPO_SYNC_MAX_ADVISORIES", 10_000)
LINUX_REPO_SYNC_MAX_PACKAGES_PER_ADVISORY = _int_env(
    "PATCH_LINUX_REPO_SYNC_MAX_PACKAGES_PER_ADVISORY", 512
)
