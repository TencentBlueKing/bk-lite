...
class ProviderManifest(BaseModel):
    ...
    base_connection_adapter_key: str = Field(default="", description="基础连接校验 adapter 注册键")
    base_connection_adapter_path: str = Field(default="", description="基础连接校验 adapter 类导入路径")
