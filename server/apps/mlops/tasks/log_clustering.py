...
def publish_dataset_release_async(release_id, train_file_id, val_file_id, test_file_id):
    ...
    try:
        ...
        logger.info(f"开始发布日志聚类数据集 - Dataset: {dataset.id}, Version: {version}, Release ID: {release_id}")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(zip_path, 'rb') as f:
                ...
                zip_object_path = f'log_clustering_datasets/{dataset.id}/{date_prefixed_path}'
            ...
            logger.info(f"日志聚类数据集发布成功 - Release ID: {release.id}, 样本数: {train_samples}/{val_samples}/{test_samples}")
