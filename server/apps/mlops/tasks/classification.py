...
def publish_dataset_release_async(release_id, train_file_id, val_file_id, test_file_id):
    ...
    try:
        ...
        # 获取发布记录
        release = ClassificationDatasetRelease.objects.get(id=release_id)
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # 创建ZIP压缩包
            zip_filename = f"classification_dataset_{dataset.name}_{version}.zip"
            ...
            with open(zip_path, 'rb') as f:
                ...
                zip_object_path = f'classification_datasets/{dataset.id}/{date_prefixed_path}'
