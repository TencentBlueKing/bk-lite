...
@receiver(post_delete, sender=ImageClassificationDatasetRelease)
...
@receiver(post_delete, sender=ImageClassificationTrainData)
...
@receiver(post_delete, sender=ImageClassificationTrainJob)
