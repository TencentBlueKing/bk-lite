...
@receiver(post_delete, sender=ObjectDetectionDatasetRelease)
...
@receiver(post_delete, sender=ObjectDetectionTrainData)
...
@receiver(post_delete, sender=ObjectDetectionTrainJob)
