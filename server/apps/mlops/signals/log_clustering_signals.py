...
@receiver(post_delete, sender=LogClusteringDatasetRelease)
...
@receiver(post_delete, sender=LogClusteringTrainData)
...
@receiver(post_delete, sender=LogClusteringTrainJob)
