...
class LogClusteringTrainData(TrainDataFileCleanupMixin, MaintainerInfo, TimeInfo):
    """日志聚类训练数据模型"""
...
class LogClusteringTrainJob(TrainJobConfigSyncMixin, MaintainerInfo, TimeInfo):
    """日志聚类训练任务"""

    _model_prefix = "LogClustering"
