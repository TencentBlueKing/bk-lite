...
class ClassificationTrainData(TrainDataFileCleanupMixin, MaintainerInfo, TimeInfo):
    """分类任务训练数据模型"""
...
class ClassificationTrainJob(TrainJobConfigSyncMixin, MaintainerInfo, TimeInfo):
    """分类任务训练作业"""

    _model_prefix = "Classification"
