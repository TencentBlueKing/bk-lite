...
def test_build_room_layout_places_and_collects_unplaced_and_conflicts():
    racks = [
        {"inst_id": "1", "inst_name": "A01", "row": 1, "col": 1, "u_count": 42, "datacenter_type": "1", "datacenter_state": "1", "used_u": 21},
        {"inst_id": "2", "inst_name": "A02", "row": 2, "col": 1, "u_count": 42, "datacenter_type": "1", "datacenter_state": "1", "used_u": 0},
        {"inst_id": "3", "inst_name": "B01", "row": 1, "col": 1, "u_count": 42, "datacenter_type": "2", "datacenter_state": "1", "used_u": 10},
        {"inst_id": "4", "inst_name": "未定位", "row": None, "col": None, "u_count": 42, "datacenter_type": "1", "datacenter_state": "1", "used_u": 0},
    ]
...
def test_build_room_layout_zero_u_count_guards_division():
    racks = [
        {"inst_id": "9", "inst_name": "无U数", "row": 1, "col": 2, "u_count": 0, "datacenter_type": "1", "datacenter_state": "1", "used_u": 0},
    ]
    out = build_room_layout(racks)
...
def test_build_rack_layout_placed_unplaced_overflow_overlap():
    devices = [
        {"inst_id": "10", "inst_name": "sw", "model_id": "switch", "rack_u_start": 41, "u_size": 2},
        {"inst_id": "11", "inst_name": "srv", "model_id": "physcial_server", "rack_u_start": 42, "u_size": 2},
        {"inst_id": "12", "inst_name": "no-u", "model_id": "switch", "rack_u_start": None, "u_size": None},
    ]
...
def test_build_rack_layout_free_and_max_contiguous():
    ...
    devices = [
        {"inst_id": "1", "inst_name": "srv", "model_id": "physcial_server", "rack_u_start": 3, "u_size": 3},
    ]
