...
class CmdbModuleIngestService:
    ...
    def _handle_lifecycle(
        ...
        *,
        ...
        public_id = cls._public_cmdb_id(updated if isinstance(updated, dict) else existing)
        return IngestResult(
            id=public_id,
            updated=True,
        ).as_dict()
    ...
    def _build_desired(
        ...
        *,
        ...
        if model_id == "host":
            return cls._build_host_desired(raw=raw, node_id=node_id, monitor_id=monitor_id)
