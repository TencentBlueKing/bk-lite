...
class CollectorFilter(filters.FilterSet):
    ...
    node_operating_system = filters.CharFilter(field_name="node_operating_system", lookup_expr="exact", label="操作系统")
    ...
    class Meta:
        model = Collector
        fields = ["name", "node_operating_system", "cpu_architecture", "tags"]
