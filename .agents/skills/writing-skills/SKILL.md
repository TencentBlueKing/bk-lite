...
**Personal skills live in Codex skill directories (`~/.codex/skills` globally or `.agents/skills/` inside this repo).**
...
**Official guidance:** Prefer Codex's local skill format: a directory with `SKILL.md` frontmatter and only the supporting files that the skill explicitly references. This document adds a TDD-focused process for writing and verifying those skills.
