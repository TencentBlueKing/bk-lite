...
Some imported skills may use legacy tool names. In Gemini CLI, use these equivalents:
...
These tools are available in Gemini CLI but may not have equivalents in other agents:
