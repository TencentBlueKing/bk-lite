...
// The browser SDK (packages/core-rum-sdk) and the gateway receiver each commit
...
func TestSDKGoldenCorpusDoesNotDriftFromGatewayFixture(t *testing.T) {
	sdkFixture, err := os.ReadFile("../../../../../../packages/core-rum-sdk/testdata/faro-2.8.2-golden.json")
