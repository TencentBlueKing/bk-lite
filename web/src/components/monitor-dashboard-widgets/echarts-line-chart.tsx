...
import type { ChartData, MetricItem, MetricUnit } from '@/components/monitor-dashboard-widgets/types';
import { renderEChartsTooltipCard } from '@/components/echarts-tooltip-card';
import ChartSurface from '@/components/chart-surface';
import { useECharts } from '@/components/monitor-dashboard-widgets/useECharts';
import {
  formatMetricValue,
