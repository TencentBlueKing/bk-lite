...
import type { TargetSourceType } from '@/components/job-host-selection-modal';
...
export function AddTargetHostButton({
  count,
  onClick,
}: AddTargetHostButtonProps) {
  const { t } = useTranslation();
