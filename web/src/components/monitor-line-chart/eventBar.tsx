...
import { useMonitorChartTimeFormatter } from '@/components/monitor-chart-runtime';
import type { TableDataItem } from '@/components/monitor-chart-runtime';
import { LEVEL_MAP } from '@/components/monitor-shared';
