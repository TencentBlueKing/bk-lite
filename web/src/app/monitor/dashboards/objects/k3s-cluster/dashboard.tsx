...
export default function K3sClusterDashboardPage() {
  ...
  const objectFallbackName = 'K3s 集群';
    ...
    <div className={styles.page}>
      <div className={styles.shell}>
        <div className={styles.pageHeader}>
          <DashboardPageHeader
            title={displayMode === 'metrics' ? `${objectFallbackName} 全量指标` : 'K3s 集群监控仪表盘'}
          ...
          <DashboardInstanceCard
            ...
            metaItems={['VMAgent', 'k3s'].map((item, i) => (
        ...
        <section className={styles.dashboardSection}>
          <div className={styles.sectionGrid}>
            <RingChartPanel
              title="节点就绪"
              guide={guide('节点就绪', '处于 Ready(可正常调度 Pod)状态的节点数 / 节点总数。有未就绪节点时,到 K3s 节点仪表盘看其资源水位与状态。')}
