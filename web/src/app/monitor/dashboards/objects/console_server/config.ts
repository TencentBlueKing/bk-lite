...
// 共享控制台服务器仪表盘：覆盖 bk-lite ConsoleServer 对象下的 SNMP 插件（首品牌 Opengear）。
...
export const CONSOLE_SERVER_DASHBOARD_CONFIG: SimpleDashboardConfig = {
  routeKey: 'console_server',
  pageTitle: '控制台服务器监控仪表盘',
  objectFallbackName: 'ConsoleServer',
  instanceType: 'console_server',
  collectionStatusQuery:
    "count({instance_type='console_server', __$labels__}) by (instance_id)",
