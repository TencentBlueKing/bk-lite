...
const ICON_LIST = [
  ...
  'cc-db2_DB2',
  'cc-sql-server_MSSQL',
  'cc-kingbase_KingBase',
  'cc-opengauss_OpenGauss',
  'cc-gbase8a_GBase8a',
  'cc-oceanbase_OceanBase',
  'cc-hana_HANA',
  'cc-iris_IRIS',
  'cc-vastbase_VastBase',
  'cc-greenplum_Greenplum',
  ...
  'mm-kingbase_KingBase',
  'mm-opengauss_OpenGauss',
  'mm-gbase8a_GBase8a',
  'mm-oceanbase_OceanBase',
  'mm-hana_HANA',
  'mm-iris_IRIS',
  'mm-vastbase_VastBase',
  'mm-greenplum_Greenplum',
