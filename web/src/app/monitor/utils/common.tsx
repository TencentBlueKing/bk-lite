...
const BRANDS: { match: RegExp; label: string; icon?: string }[] = [
  ...
  { match: /powerstore|dell\s*ps[\s_-]*scale/i, label: 'Dell PowerStore', icon: 'mm-dellpowerstore_dellpowerstore' },
  { match: /storagegrid|netapp\s*sg|netapp\s*object/i, label: 'NetApp StorageGRID', icon: 'mm-netappstoragegrid_netappstoragegrid' },
