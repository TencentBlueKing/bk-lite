...
import MonitorPolicy from '@/app/monitor/(pages)/view/monitorPolicy';
...
export interface MonitorPolicyWidgetProps {
  monitorId: string;
}

const MonitorPolicyWidget = ({ monitorId }: MonitorPolicyWidgetProps) => {
...
export default MonitorPolicyWidget;
