...
import { LEVEL_MAP as MONITOR_LEVEL_MAP } from '@/app/monitor/components/monitor-shared';
import { useMonitorLevelOptions } from '@/app/monitor/components/monitor-shared';
