...
const useRabbitmqFilebeatFormItems = () => {
      ...
      return (
        <>
          ...
          <div className="font-semibold mb-[8px]">
            {t('log.integration.rabbitmqServerLog')}
          </div>
          <div className="text-[var(--color-text-3)] mb-[12px]">
            {t('log.integration.rabbitmqServerLogDesc')}
          </div>
            ...
            <Form.Item className="mb-0">
              <div className="flex items-center">
                <div className="flex items-center w-[100px] mr-[10px]">
                  ...
                  <Tooltip title={t('log.integration.rabbitmqLogPathHint')}>
...
export { useRabbitmqFilebeatFormItems };
