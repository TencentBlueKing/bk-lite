...
const usePostgresqlFilebeatFormItems = () => {
            ...
            <Form.Item className="mb-0">
              <div className="flex items-center">
                <div className="flex items-center whitespace-nowrap mr-[10px]">
                  ...
                  <Tooltip title={t('log.integration.postgresqlLogPathHint')}>
                ...
                >
                  <Select
                    mode="tags"
                    placeholder="/var/log/postgresql/postgresql-14-main.log"
...
export { usePostgresqlFilebeatFormItems };
