...
const KafkaTrend: React.FC<KafkaTrendProps> = ({ rawData, loading = false }) => {
    ...
    return {
      ...
      series: [
        ...
        },
        {
          name: '异常堆栈日志数',
          type: 'line',
          data: sortedData.map((item) => Number(item.stack_count || 0)),
          yAxisIndex: 1,
          smooth: true,
          symbol: 'none',
