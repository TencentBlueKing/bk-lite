...
本域确认 6 个主 Finding：P0 3 个、P1 3 个、P2/P3 0 个，编号为 `CMDB-F20`–`CMDB-F25`。采集 CRUD 外部同步无持久化恢复、实例 merge 绕过统一批写编排、关联按名称裸解析分别与既有 `CMDB-F04/F11`、`CMDB-F10/F11`、`CMDB-F14` 同根因，仅记录跨域证据，不重复计数。Recommendation 为 **Block**。
