...
2. 商业版标准日志：`docs/changelog/release/enterprise/<商业月版本>.md`，例如 2025年9月为 `3.0.md`，2025年10月为 `3.1.md`
3. 社区版模块日志：`web/src/app/<module>/public/versions/<module>/<zh|en>/YYYY-MM-DD.md`
4. 商业版模块日志：`enterprise/web/src/app/<module>/public/versions/<module>/<zh|en>/<商业月版本>.md`，例如 2025年9月为 `3.0.md`，2025年10月为 `3.1.md`

## 总原则

- `docs/changelog/release.md` 是唯一人工维护的原始版本记录。
- 社区版以日期作为版本号，文件名为 `YYYY-MM-DD.md`。
- 商业版以自然月聚合为正式版本，起点为 `2025年9月 -> 3.0`，后续自然月递增，例如 `2025年10月 -> 3.1`、`2026年5月 -> 3.8`。
...
- 商业版 3.0 对应 2025年9月。
- 商业版 3.1 对应 2025年10月。
- 中文示例中，2025年9月实际文件的 `<商业月版本>` 为 `3.0`。
...
英文示例中，2025年9月实际文件的 `<商业月版本>` 为 `3.0`。
...
6. 商业版月份映射是否正确：`2025年9月 -> 3.0`、`2025年10月 -> 3.1`、`2026年5月 -> 3.8`。
