...
`docs/changelog/release.md` 原始条目没有明确分类时，按以下规则归类：

- 条目包含“新增”“支持”“上线”“开放”“提供”时，通常归入 `功能新增`。
- 条目包含“优化”“修复”“调整”“重构”“升级”“兼容”时，通常归入 `功能优化`。
- 同一条同时命中新增词和优化词时，以条目中更明确的语义为准。
- 如果无法判断分类，保留原模块名，将条目写入 `TODO:`，并注明确认位置：`docs/changelog/release.md` + 日期 + 模块 + 条目关键词。
