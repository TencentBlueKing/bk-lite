...
> 面向第一次接触该功能的开发者和评审者。目标是在 10 分钟内理解需求、关键接口、可靠性边界与发布条件；实现细节以代码和[完整规格](../superpowers/specs/2026-07-21-incident-feishu-im-group-design.md)为准。
...
- [完整需求与前后端规格](../superpowers/specs/2026-07-21-incident-feishu-im-group-design.md)
- [TDD 实施计划](../superpowers/plans/2026-07-21-incident-feishu-im-group.md)
- [产品决策记忆（范围与语义 SSOT）](../design/product-decisions/incident-im-collaboration.md)
- [最终验证报告](../reviews/incident-feishu-group-validation-2026-07-21.md)
- [真实飞书验证 Runbook](../validation/incident-feishu-group-runbook.md)
