...
- 非关键外部资源不得进入阻断启动的必经路径，详见 [可靠性红线](../governance/reliability.md)。
- 数据库访问必须遵守 [安全红线](../governance/security.md) 与后端编码规范。

## 继续阅读

- [开发与运行](../operations.md)
- [后端编码规范](../backend-coding-guide.md)
- [前端工程规则](frontend.md)
- [质量门禁](../governance/quality.md)
- [生成式数据库结构](../generated/db-schema.md)
